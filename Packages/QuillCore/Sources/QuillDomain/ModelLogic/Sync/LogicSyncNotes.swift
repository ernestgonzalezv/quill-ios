...
/// 3. **Merge** via ``LogicNoteMerger`` (pure, testable, no I/O).
...
public struct LogicSyncNotes: Sendable {
    private let repository: any ProtoNoteRepository
    private let remote: any ProtoRemoteNoteStore
    private let cursor: any ProtoSyncCursorStore
    ...
    public init(
        ...
        remote: any ProtoRemoteNoteStore,
        cursor: any ProtoSyncCursorStore,
        merger: LogicNoteMerger = LogicNoteMerger(),
